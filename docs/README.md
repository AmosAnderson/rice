...
RICE BASIC is a structured BASIC interpreter written in Rust, implementing a QBasic/FreeBASIC dialect. It supports an interactive REPL and file execution. No graphics or sound support.
